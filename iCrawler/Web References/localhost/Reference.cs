...
namespace iCrawler.localhost {
    ...
    public partial class iTrackingServices : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public iTrackingServices() {
            this.Url = global::iCrawler.Properties.Settings.Default.iCrawler_localhost_iTrackingServices;
        ...
        public Article GetArticle(string appName, System.Guid articleId) {
        ...
        /// <remarks/>
        public void GetArticleAsync(string appName, System.Guid articleId) {
            this.GetArticleAsync(appName, articleId, null);
        }
        
        /// <remarks/>
        public void GetArticleAsync(string appName, System.Guid articleId, object userState) {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/PostArticle", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public Article PostArticle(string crawlerName, Article article) {
        ...
        /// <remarks/>
        public void PostArticleAsync(string crawlerName, Article article) {
            this.PostArticleAsync(crawlerName, article, null);
        }
        
        /// <remarks/>
        public void PostArticleAsync(string crawlerName, Article article, object userState) {
        ...
        public Article CreateArticle(string crawlerName, string title, string summary, string content, string author, string createby, string tags) {
        ...
        /// <remarks/>
        public void CreateArticleAsync(string crawlerName, string title, string summary, string content, string author, string createby, string tags) {
            this.CreateArticleAsync(crawlerName, title, summary, content, author, createby, tags, null);
        }
        
        /// <remarks/>
        public void CreateArticleAsync(string crawlerName, string title, string summary, string content, string author, string createby, string tags, object userState) {
            ...
            this.InvokeAsync("CreateArticle", new object[] {
                        ...
                        author,
                        createby,
                        tags}, this.CreateArticleOperationCompleted, userState);
        }
